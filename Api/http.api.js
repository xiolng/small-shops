const install = (Vue, vm) => {
	vm.$u.api = {
		 ...
		 *************************************************/
		 ...
		 // 查询热卖商品
		 getBaseShell: data => vm.$u.get(`/business/product/getBaseShell`, data),
		/*************************************************
		 * 订单管理
		 *************************************************/
		 // 订单分页列表
		 ...
		 *************************************************/
		 ...
		 // 设置默认收货地址
		 setDefaultMemeberReceive: params => vm.$u.get(`/business/memberReceive/setDefaultMemeberReceive`, params),
		 // 更新收货地址
